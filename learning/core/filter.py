...
img = cv2.imread("processed/3/bin_2.tif")
...
# cv2.imwrite("processed/3/bin_2_median.tif", img_median)
...
# 非局部均值去噪
dst = cv2.fastNlMeansDenoising(img_median,None,3,7,21)
cv2.imwrite("processed/3/bin_2_denoising.tif",dst)